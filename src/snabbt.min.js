/* snabbt.js Version: 0.6.4 Build date: 2015-12-27 (c) 2015 Daniel Lundin @license MIT */ ! function(t) {
  if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
    ...
    var n;
    n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, n.snabbt = t()
  }
}(function() {
  return function t(n, e, i) {
    ...
    2: [function(t, n) {
      ...
      function e(t, n, e, i) {
        ...
        var p = -1,
          ...
          g = void 0,
          A = void 0;
        return A = e.valueFeeder ? a.createValueFeederTweener(e.valueFeeder, t, n, f) : a.createStateTweener(t, n, f), {
          options: e,
          endState: function() {
            return n
          },
          ...
          tick: function(t) {
            ...
            if (-1 === p && (p = t), t - p >= u) {
              ...
              c.tick(0 === s ? 1 : n / s), this.updateCurrentTransform(), e.update && e.update(n / s), this.completed() && g && g()
            }
          },
          ...
          updateElement: function(t, n) {
            if (h || n) {
              var o = A.asMatrix(),
                a = A.getProperties();
              r.updateElementTransform(t, o, i, a.perspective, e.staticTransform), r.updateElementProperties(t, a)
            }
          }
        }
      }
      ...
      function i(t) {
        ...
        return {
          ...
          updateMovement: function() {
            var t = e.getValue();
            i && (p.position[0] = n.position[0] * t, p.position[1] = n.position[1] * t, p.position[2] = n.position[2] * t), a && (p.rotation[0] = n.rotation[0] * t, p.rotation[1] = n.rotation[1] * t, p.rotation[2] = n.rotation[2] * t), u && (p.rotationPost[0] = n.rotationPost[0] * t, p.rotationPost[1] = n.rotationPost[1] * t, p.rotationPost[2] = n.rotationPost[2] * t), c && (p.scale[0] = 1 + n.scale[0] * t, p.scale[1] = 1 + n.scale[1] * t), f && (p.skew[0] = n.skew[0] * t, p.skew[1] = n.skew[1] * t)
          },
          updateElement: function(t) {
            r.updateElementTransform(t, p.asMatrix()), r.updateElementProperties(t, p.getProperties())
          },
          getCurrentState: function() {
            return p
          },
          ...
          return {
            ...
            tick: function(t, s) {
              if (0 !== t && !s && !u) {
                var c = -(n - e) * r,
                  f = c / a;
                i += f, n += i, i *= o, Math.abs(n - e) < .001 && Math.abs(i) < .001 && (u = !0)
              }
            },
      ...
      var e = t("./state.js").stateFromOptions,
        ...
        a = {
          ...
          scheduleNextFrame: function() {
            var t = this;
            this.rAFScheduled || (this.rAFScheduled = !0, window.requestAnimationFrame(function(n) {
          ...
          stepAnimations: function(t) {
            ...
            }), this.archiveCompletedAnimations(), this.runningAnimations.length > 0 && this.scheduleNextFrame()
          },
          ...
          archiveCompletedAnimations: function() {
            ...
            a.runningAnimations = t, this.completedAnimations = this.completedAnimations.filter(function(t) {
              return !i.find(function(n) {
                return n[0] === t[0]
              })
            }), Array.prototype.push.apply(this.completedAnimations, i), Array.prototype.push.apply(this.runningAnimations, e), n.forEach(function(t) {
            ...
            var n = this,
              e = t.filter(function(t) {
                ...
                var e = t[0],
                  i = t[2],
                  r = i.queue[i.index];
                return i.index++, [t[0], n.createAnimation(e, r, t[1].endState()), i]
              });
            return e
          },
          ...
          initializeAnimation: function(t, n, e) {
            ...
            return i.updateElement(t, !0), this.runningAnimations.push([t, i, r]), this.scheduleNextFrame(), n.manual ? i : r
          },
          findCurrentState: function(t) {
            var n = this.runningAnimations.find(function(n) {
              return t === n[0]
            });
            return n ? n[1].getCurrentState() : (n = this.completedAnimations.find(function(n) {
              return t === n[0]
    ...
    5: [function(t, n) {
      ...
      function e(t, n, e) {
        if (!t.length) return "string" == typeof n ? i.initializeAnimation(t, n, r(e, 0, 1)) : i.initializeAnimation(t, r(n, 0, 1), e);
        for (var a = [], s = {
            snabbt: function(t) {
              var n = a.length;
          ...
          }, u = 0, c = t.length; c > u; ++u) a.push("string" == typeof n ? i.initializeAnimation(t[u], n, r(e, u, c)) : i.initializeAnimation(t[u], r(n, u, c), e));
        return s
      }
      ...
      n.exports = function(t, n, i) {
        return e(t, n, i)
      }, n.exports.createMatrix = a, n.exports.setElementTransform = s, n.exports.sequence = function(t) {
        var n = -1,
          i = function r() {
            if (++n, !(n > t.length - 1)) {
              var i = t[n][0],
    ...
    6: [function(t, n) {
      ...
      function e(t, n, e) {
        return e[0] = t[0] * n[0] + t[1] * n[4] + t[2] * n[8] + t[3] * n[12], e[1] = t[0] * n[1] + t[1] * n[5] + t[2] * n[9] + t[3] * n[13], e[2] = t[0] * n[2] + t[1] * n[6] + t[2] * n[10] + t[3] * n[14], e[3] = t[0] * n[3] + t[1] * n[7] + t[2] * n[11] + t[3] * n[15], e[4] = t[4] * n[0] + t[5] * n[4] + t[6] * n[8] + t[7] * n[12], e[5] = t[4] * n[1] + t[5] * n[5] + t[6] * n[9] + t[7] * n[13], e[6] = t[4] * n[2] + t[5] * n[6] + t[6] * n[10] + t[7] * n[14], e[7] = t[4] * n[3] + t[5] * n[7] + t[6] * n[11] + t[7] * n[15], e[8] = t[8] * n[0] + t[9] * n[4] + t[10] * n[8] + t[11] * n[12], e[9] = t[8] * n[1] + t[9] * n[5] + t[10] * n[9] + t[11] * n[13], e[10] = t[8] * n[2] + t[9] * n[6] + t[10] * n[10] + t[11] * n[14], e[11] = t[8] * n[3] + t[9] * n[7] + t[10] * n[11] + t[11] * n[15], e[12] = t[12] * n[0] + t[13] * n[4] + t[14] * n[8] + t[15] * n[12], e[13] = t[12] * n[1] + t[13] * n[5] + t[14] * n[9] + t[15] * n[13], e[14] = t[12] * n[2] + t[13] * n[6] + t[14] * n[10] + t[15] * n[14], e[15] = t[12] * n[3] + t[13] * n[7] + t[14] * n[11] + t[15] * n[15], e
      }

      function i(t, n, e, i) {
        t[0] = 1, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = 1, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = n, t[13] = e, t[14] = i, t[15] = 1
      }

      function r(t, n) {
        t[0] = 1, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = Math.cos(n), t[6] = -Math.sin(n), t[7] = 0, t[8] = 0, t[9] = Math.sin(n), t[10] = Math.cos(n), t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
      }

      function o(t, n) {
        t[0] = Math.cos(n), t[1] = -Math.sin(n), t[2] = 0, t[3] = 0, t[4] = Math.sin(n), t[5] = Math.cos(n), t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
      }

      function a(t, n, e) {
        t[0] = 1, t[1] = Math.tan(n), t[2] = 0, t[3] = 0, t[4] = Math.tan(e), t[5] = 1, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
      }

      function s(t, n, e) {
        t[0] = n, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = e, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
      }
      ...
      function c(t, n) {
        n[0] = t[0], n[1] = t[1], n[2] = t[2], n[3] = t[3], n[4] = t[4], n[5] = t[5], n[6] = t[6], n[7] = t[7], n[8] = t[8], n[9] = t[9], n[10] = t[10], n[11] = t[11], n[12] = t[12], n[13] = t[13], n[14] = t[14], n[15] = t[15]
      }
      ...
      function f() {
        ...
        return u(t), {
          data: t,
          asCSS: function() {
            for (var n = "matrix3d(", e = 0; 15 > e; ++e) n += Math.abs(t[e]) < 1e-4 ? "0," : t[e].toFixed(10) + ",";
      ...
      var p = function(t, n) {
        t[0] = Math.cos(n), t[1] = 0, t[2] = Math.sin(n), t[3] = 0, t[4] = 0, t[5] = 1, t[6] = 0, t[7] = 0, t[8] = -Math.sin(n), t[9] = 0, t[10] = Math.cos(n), t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
      };
      n.exports = f
    }, {}],
    7: [function(t, n) {
      ...
      function i(t, n, i) {
        ...
        var c = Object.keys(u).concat(["perspective", "transformOrigin", "duration", "delay"]);
        return c.forEach(function(a) {
          var s = e(a);
          r.isFunction(t[a]) && (o[a] = t[a](n, i)), r.isFunction(t[s]) && (o[s] = t[s](n, i))
        }), o
      }
      var r = t("./utils.js"),
        o = 1,
    ...
    8: [function(t, n) {
        ...
        var i = r(),
          ...
          c = {
            ...
            getProperties: function() {
              return a.opacity = this.opacity, a.width = this.width + "px", a.height = this.height + "px", a.perspective = this.perspective, a
            }
          };
        return Object.keys(o).forEach(function(e) {
      ...
      function i(t, n, i) {
        ...
        return Object.keys(o).forEach(function(n) {
          r[n] = u.optionOrDefault(t[s(n)], r[n]), r[n] && r[n].slice && (r[n] = r[n].slice())
        }), r
      }
      var r = t("./matrix.js"),
        ...
        return Object.keys(o).forEach(function(t) {
          ...
          tween: function(t) {
            p.forEach(function(n) {
              var e = o[n][0];
              e === a.ARRAY_3 ? i(u, c, f, n, t) : e === a.ARRAY_2 ? r(u, c, f, n, t) : s(u, c, f, n, t)
            })
          },
          asMatrix: function() {
            return f.asMatrix()
      ...
      function i(t, n, e, i) {
        ...
        return {
          tween: function(n) {
            ...
            void 0 !== s.width && (u.width = a.width + n * e), void 0 !== s.height && (u.height = a.height + n * i), void 0 !== s.opacity && (u.opacity = a.opacity + n * r)
          },
          asMatrix: function() {
            return o
          },
